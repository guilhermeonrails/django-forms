...
class PassagemForms(forms.Form):
    ...
    data_ida = forms.DateField(label='Ida', widget=forms.SelectDateWidget(), initial=datetime.today)
    data_volta = forms.DateField(label='Volta', widget=forms.SelectDateWidget(), initial=datetime.today)
